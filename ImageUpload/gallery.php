        ...
        <div class="wrapper">
            <footer>
                ...
                <ul class="footer-links-cases">
                    ...
                    <li><a href="#"></a>MALING SHAOLIN - WEB DEVELOPMENT</li>
                    <li><a href="#"></a>EXELLENTO - WEB DEVELOPMENT, SEO</li>
                    <li><a href="#"></a>MMTUTS - YOUTUBE CHANNEL</li>
                    <li><a href="#"></a>WELTEC - VIDEO PRODUCTION</li>
                </ul>
